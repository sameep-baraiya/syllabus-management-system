...
import DeleteAnnouncement from '../../models/announcement/DeleteAnnouncement';
...
const ABDeleteAnnouncement = () => {
  ...
  return (
    <div>
      ...
      <hr />
      <DeleteAnnouncement mode={mode} setMode={setMode} />
      <br />
    </div>
  );
};

export default ABDeleteAnnouncement;
