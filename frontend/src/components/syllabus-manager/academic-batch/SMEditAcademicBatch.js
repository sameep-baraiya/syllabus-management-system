...
import EditAcademicBatch from '../../models/academic-batch/EditAcademicBatch';
...
const SMEditAcademicBatch = () => {
  ...
  return (
    <div>
      <h2>
        <strong>Edit Academic Batch</strong>
      </h2>
      <div className='mb-3'>
        Select operation :{' '}
        <Button
      ...
      <hr />
      <EditAcademicBatch mode={mode} setMode={setMode} />
    </div>
  );
};

export default SMEditAcademicBatch;
