  ...
  return (
    <Fragment>
      <Form onSubmit={onSubmit}>
        <Form.Group controlId='acMeetingCode'>
        ...
        <Form.Group controlId='acMeetingsNotes'>
        ...
        <Form.Group controlId='acDepartment'>
        ...
        <Form.Group controlId='acDateOfMeeting'>
        ...
        <Form.Group controlId='acRequestedChanges'>
        ...
        {/* TODO Refactor upload module */}
        <Form.Group controlId='acFiles'>
          <Form.Label>Upload Academic Council Meeting Related Files</Form.Label>
          <Card>
            <Card.Body>
              {files.map((it, index) => (
                <Row key={index}>
...
export default CreateACMeeting;
